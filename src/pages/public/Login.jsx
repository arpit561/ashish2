...
import loginImg from '../../assets/i2.png'
        ...
        <Container>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 rounded-lg shadow-lg w-full md:w-auto m-4'>
                <div className='flex flex-col justify-center p-4'>
                    <p className='text-md md:text-lg font-medium text-blue-400'>Welcome back 👋</p>
                    <p className='text-lg md:text-xl font-medium text-blue-400 mt-2'>Login here</p>
                    <Input
                        type="email"
                        label={"Email*"}
                    ...
                    <Button
                        className="w-full p-2 rounded-full bg-blue-500 hover:bg-blue-600 mt-4"
                        labelClassName="text-blue-100 text-md"
                        label={'login'}
                        rightIcon={
                            <BiLogInCircle
                    ...
                    <Button
                        className="w-full p-2 rounded-full bg-blue-600 hover:bg-blue-500 "
                        labelClassName="text-blue-100 text-md"
                ...
                <div className='hidden md:block w-[300px]'>
                    <img src={loginImg} alt='login' className='h-[80%] pt-[50px] w-full' />
                </div>
            </div>
        </Container>
    )
