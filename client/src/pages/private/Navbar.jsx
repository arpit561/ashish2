            ...
            {isAuthenticated && (
              <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                <Button
                  ...
                  className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-700"
                />
              </div>
            )}
            {!isAuthenticated && (
              ...
              <div className="py-6 px-5 space-y-6">
                <div className="w-full">
                  <Button
                    ...
                    label="Logout"
                    onClick={() => handleLogout()}
                    className=" whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-full shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-700 w-full"
                  />
                </div>
              </div>
            </div>
