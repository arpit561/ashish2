                    ...
                    <TabGroup>
                        <TabList>
                            {TAB_LIST.map((name, index) => (
                                <Tab
                                    key={name}
                                    className="rounded-full py-1 px-3 mr-2 mb-2 text-sm/6 font-semibold text-gray-700 bg-white shadow-md data-[selected]:text-gray-100 focus:outline-none data-[selected]:bg-blue-400 data-[hover]:bg-blue-300 data-[selected]:data-[hover]:bg-blue-500 data-[focus]:outline-1 data-[focus]:outline-white"
                                >
                                    {name}
                                </Tab>
                            ))}
